    ...
    function giffont() {
        ...
        for($i = 0; $i <= 3; $i++) {
            ...
            if(!empty($this->imcodefile) && file_exists($this->imcodefile)) {
                ...
                $w = abs($this->width / 5 - $font[$i]['width']);
                $tt = mt_rand(-$w, $w);
                $font[$i]['width'] += $tt;
        ...
        for($i = 0; $i <= 3; $i++) {
            ...
            if($font[$i]['file']) {
                ...
                $h = abs($this->height - $font[$i]['height']);
                $y = mt_rand(-$h, $h);

                if($this->shadow) {
                    $this->imcodeshadow = $this->imcode;
                    imagecolorset($this->imcodeshadow, 0, 0, 0, 0);
                    imagecopyresized($this->im, $this->imcodeshadow, $x, $y, 0, 0, $font[$i]['width'], $font[$i]['height'], $font[$i]['data'][0], $font[$i]['data'][1]);
                }
